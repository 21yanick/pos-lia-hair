...
-- RLS Policies
 ...
 DROP POLICY IF EXISTS enable_all_access_for_service_role ON public.business_settings;
 CREATE POLICY enable_all_access_for_service_role ON public.business_settings FOR ALL TO service_role USING (true) ;                                                   
