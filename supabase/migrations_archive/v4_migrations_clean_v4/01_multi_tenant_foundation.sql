...
-- =====================================================
-- Clean Multi-Tenant Foundation extracted from Production
...
-- =====================================================
-- ROW LEVEL SECURITY (CLEAN MULTI-TENANT DESIGN)
-- =====================================================
...
CREATE POLICY organization_users_access ON public.organization_users 
...
-- =====================================================
-- END OF 01_multi_tenant_foundation.sql
-- =====================================================
-- Next: 02_core_pos_business.sql (POS System + Appointments)
-- Next: 03_banking_and_compliance.sql (Swiss Banking + Legal)  
-- Next: 04_performance_and_security.sql (Indexes + RLS + Views)
-- =====================================================