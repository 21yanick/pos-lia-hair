  ...
  public: {
    Tables: {
      ...
      owner_transactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "owner_transactions_related_bank_transaction_id_fkey"
            columns: ["related_bank_transaction_id"]
            isOneToOne: false
            referencedRelation: "bank_transactions"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "owner_transactions_related_expense_id_fkey"
          ...
          {
            foreignKeyName: "owner_transactions_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      transaction_matches: {
        Row: {
          ...
          matched_type: 'sale' | 'expense' | 'provider_batch' | 'cash_movement' | 'owner_transaction'
          matched_id: string
