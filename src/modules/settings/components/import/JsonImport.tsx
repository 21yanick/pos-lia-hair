      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="break-words">
            Vollständiger Import von Produkten, Verkäufen und Ausgaben mit automatischer
            PDF-Generierung
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          {state.status === 'processing' && (
            <div className="space-y-4">
              ...
              <p className="text-xs text-muted-foreground">{state.progress}% abgeschlossen</p>
            </div>
          )}
              ...
              <AlertDescription>
                <div className="space-y-2">
                  ...
                  <div className="text-sm space-y-1">
                    ...
                    <p>
                      • Verarbeitungszeit: {Math.round(state.results.totalProcessingTime / 1000)}s
                    </p>
                  </div>
