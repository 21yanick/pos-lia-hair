    ...
    const templates = {
      ...
      sales: {
        ...
        rows: [
          [
            ...
            '65.00',
            'cash',
            'Haarschnitt Damen (Waschen+Schneiden+Föhnen):65.00',
            'Bar bezahlt - keine Gebühren',
            'completed',
            '65.00',
            '0.00',
            '65.00',
          ...
          [
            ...
            '45.00',
            'twint',
            'Haarschnitt Herren (klassisch):45.00',
            'TWINT - 3% Gebühr, T+2 Settlement',
            'completed',
            '45.00',
            '1.35',
            '43.65',
          ...
          [
            ...
            '97.50',
            'sumup',
            'Coloration (Aufpreis je nach Länge):85.00;Shampoo Kerastase 250ml:32.50',
            'SumUp - 2.75% + 0.25 CHF',
            'completed',
            '97.50',
            '2.93',
      ...
      expenses: {
        ...
        rows: [
          [
            '2200.00',
            'Miete Salon Januar 2024',
            'rent',
            'bank',
            '2024-01-05',
            'Immobilien Zürich AG',
            'RENT-2024-001',
            'Monatliche Miete Räumlichkeiten Bahnhofstrasse',
            'matched',
          ],
          [
            '287.40',
            "Haarprodukte Kerastase + L'Oréal",
            'supplies',
            'cash',
            '2024-01-08',
            'Beauty Professional GmbH',
            'BP-24-0156',
            'Shampoo, Conditioner, Styling-Produkte',
            'unmatched',
          ],
          [
            '156.80',
            'Strom + Heizung Dezember',
            'utilities',
            'bank',
            '2024-01-15',
            'EWZ Zürich',
            'EWZ-2024-001234',
            'Energiekosten Dezember 2023',
            'matched',
          ],
          [
            '45.60',
            ...
            'Coop Bau+Hobby',
            '',
            'Barzahlung Coop - keine Rechnung',
            'unmatched',
          ],
          [
            '890.00',
            'Marketing Facebook Ads Januar',
            'marketing',
            'bank',
            '2024-01-31',
            'Meta Platforms Ireland',
            'META-INV-456789',
            'Social Media Werbung Januar',
            'matched',
          ],
        ],
      },
      ...
      owner_transactions: {
        ...
        rows: [
          [
            'deposit',
            '25000.00',
            'Startkapital Salonöffnung',
            '2024-01-01',
            'bank_transfer',
            'matched',
            'Eigenkapital für Geschäftseröffnung Januar 2024',
          ],
          [
            'expense',
            '8950.00',
            'Renovierung + Ausrüstung',
            '2024-01-15',
            'private_card',
            'matched',
            'Friseurstühle, Waschbecken, Spiegel - Privatkarte Lia',
          ],
          [
            'expense',
            '2340.50',
            'Erstausstattung Produkte',
            '2024-01-20',
            'private_cash',
            'unmatched',
            'Startbestand Haarprodukte - bar bezahlt',
          ],
          [
            'withdrawal',
            '3500.00',
            'Privatentnahme Januar',
            '2024-01-31',
            'bank_transfer',
            'matched',
            'Lohn/Entnahme Inhaberin Januar',
          ],
          [
            'deposit',
            '1200.00',
            'Zusatzkapital Frühjahr',
            '2024-04-01',
            'bank_transfer',
            'matched',
            'Zusätzliche Einlage für Sommersaison-Vorbereitung',
          ],
        ],
      },
      bank_accounts: {
        ...
        rows: [
          [
            'Geschäftskonto Coiffure Lia',
            'UBS Switzerland AG',
            'CH93 0024 5245 1234 5678 9',
            'UBS-240001234',
            '18756.45',
            '2024-01-31',
            'true',
            'Hauptgeschäftskonto für tägl. Umsätze + Ausgaben',
          ],
          [
            'Sparkonto Rücklagen',
            'Zürcher Kantonalbank',
            'CH54 0070 0110 0023 2456 1',
            'ZKB-110234561',
            '35200.00',
            '2024-01-31',
            'true',
            'Steuern, Investitionen, Notreserve',
          ],
          [
            'Privatkonto Lia Schmid',
            'PostFinance AG',
            'CH17 0900 0000 3012 3456 7',
            'PF-30123456',
            '12450.80',
            '2024-01-31',
            'true',
            'Privatkonto für Owner Transactions + Entnahmen',
          ],
          [
            'Altes Konto (geschlossen)',
            'Credit Suisse (historisch)',
            'CH45 0483 5012 3456 7800 0',
            'CS-50123456',
            '0.00',
            '2023-06-30',
            'false',
            'Geschlossen vor Salonöffnung - nur für historische Daten',
          ],
        ],
      },
      suppliers: {
        ...
        rows: [
          [
            'Beauty Professional Schweiz GmbH',
            'beauty-professional-schweiz-gmbh',
            'beauty_supplies',
            'orders@beautypro.ch',
            '+41 44 567 89 12',
            ...
            'Zürich',
            'CH',
            'CH12 0070 0114 8012 3456 7',
            'CHE-234.567.890',
            'true',
            "Kerastase, L'Oréal Professional - Hauptlieferant",
          ],
          [
            'Immobilien Bahnhof AG',
            'immobilien-bahnhof-ag',
            'real_estate',
            'vermietung@bahnhof-properties.ch',
            '+41 44 321 65 43',
            'https://bahnhof-properties.ch',
            'Bahnhofstrasse 87',
            'Büro 205',
            '8001',
            'Zürich',
            'CH',
            'CH54 0024 5245 7890 1234 5',
            'CHE-345.678.901',
            'true',
            'Vermieter Salon Räumlichkeiten - Mietvertrag bis 2026',
          ],
          [
            'EWZ Elektrizitätswerk Zürich',
            'ewz-elektrizitaetswerk-zuerich',
            'utilities',
            'kundendienst@ewz.ch',
            '+41 58 319 41 11',
            'https://ewz.ch',
            ...
            'CHE-109.240.709',
            'true',
            'Strom + Heizung - monatliche Abrechnung',
          ],
          [
            'Coop Bau+Hobby',
            'coop-bau-hobby',
            ...
            '',
            'true',
            'Reinigungsmittel, Handtücher - Barzahlung meist',
          ],
          [
            'Swisscom (Schweiz) AG',
            'swisscom-schweiz-ag',
            'services',
            'business@swisscom.com',
            '+41 800 800 800',
            'https://swisscom.ch',
            ...
            'Worblaufen',
            'CH',
            'CH95 0023 5235 8940 4000 1',
            'CHE-107.418.778',
            'true',
            'Internet, Telefon, Mobile - Business Paket',
          ],
        ],
      },
    }
    ...
    <div className="space-y-4">
      ...
      <div className="bg-muted/50 p-4 rounded-lg">
        <div className="flex items-center justify-between">
          ...
          <Button variant="outline" size="sm" onClick={() => generateTemplate(selectedImportType)}>
      ...
      <Alert>
        ...
        <AlertDescription>
          <div className="space-y-1">
            <p>
              <strong>Datei geladen:</strong> {csvState.file?.name}
            </p>
            <p>
              <strong>Größe:</strong> {Math.round((csvState.file?.size || 0) / 1024)} KB
            </p>
            <p>
              <strong>Zeilen:</strong> {csvState.parsedData?.rows.length || 0}
            </p>
            <p>
              <strong>Spalten:</strong> {csvState.parsedData?.headers.length || 0}
            </p>
          </div>
        </AlertDescription>
      </Alert>
          ...
          <AlertDescription>
            <div className="space-y-2">
              ...
              <div className="text-sm space-y-1">
                ...
                <p>
                  • Verarbeitungszeit: {Math.round(importState.results.totalProcessingTime / 1000)}s
                </p>
              </div>
    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          {(csvState.status === 'importing' || csvState.status === 'success') &&
            renderImportResults()}
        </CardContent>
      </Card>
