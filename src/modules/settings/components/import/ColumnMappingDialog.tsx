    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden">
        <DialogHeader>
          ...
          <DialogDescription>
            Ordnen Sie die CSV-Spalten den entsprechenden Datenfeldern zu. Pflichtfelder sind mit
            ...
            <CardContent>
              <div className="space-y-4">
                {fieldDefinitions.map((field) => {
                  ...
                  const hasError =
                    field.required && (!mapping?.csvHeader || !mapping.csvHeader.trim())
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            {mapping?.csvHeader &&
                              mapping.csvHeader !== '' &&
                              !availableHeaders.includes(mapping.csvHeader) && (
                        ...
                        {mapping?.sampleValue && (
                          <p className="text-xs text-muted-foreground mt-1">
                            Beispielwert:{' '}
                            <code className="bg-muted px-1 rounded">{mapping.sampleValue}</code>
                          </p>
                        )}
                      </div>
                    </div>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleConfirm} disabled={!isValid} className="min-w-[120px]">
            {isValid ? (
              <>
