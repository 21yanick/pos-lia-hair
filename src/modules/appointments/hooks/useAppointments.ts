  ...
  return useMutation({
    ...
    onSuccess: (newAppointment) => {
      ...
      if (newAppointment.customer_id) {
        queryClient.invalidateQueries({
          queryKey: queryKeys.business.appointments.byCustomer(organizationId, newAppointment.customer_id)
        })
      }
    },
    onError: (error) => {
  ...
  return useMutation({
    ...
    onSuccess: (updatedAppointment) => {
      ...
      if (updatedAppointment.customer_id) {
        queryClient.invalidateQueries({
          queryKey: queryKeys.business.appointments.byCustomer(organizationId, updatedAppointment.customer_id)
        })
      }
    },
    onError: (error) => {
  ...
  return useMutation({
    ...
    onSuccess: (cancelledAppointment) => {
      ...
      if (cancelledAppointment.customer_id) {
        queryClient.invalidateQueries({
          queryKey: queryKeys.business.appointments.byCustomer(organizationId, cancelledAppointment.customer_id)
        })
      }
    },
    onError: (error) => {
