...
const REAL_TWINT_TRANSACTIONS = [
  {
    ...
    amount: 76.99,
    fee: 1.01,
    id: 'ddc27e5c-83ab-445f-b2cd-cef1575d4951',
  },
  {
    date: '2025-04-02',
    time: '11:15',
    amount: 29.61,
    fee: 0.39,
    id: '70d0909a-4d4d-4295-ac01-595dbdb97b3b',
  },
  {
    date: '2025-04-02',
    time: '11:17',
    amount: 24.67,
    fee: 0.33,
    id: 'be7c9c7d-2d26-46e6-bdd9-75a8b8f0255b',
  },
  {
    date: '2025-04-09',
    time: '11:11',
    amount: 95.74,
    fee: 1.26,
    id: 'db2506d3-290e-4cc4-a739-2f1162446c84',
  },
  {
    date: '2025-04-09',
    time: '12:15',
    amount: 54.28,
    fee: 0.72,
    id: 'd192c774-4def-4487-a1bd-b5540bc3a335',
  },
  {
    date: '2025-04-11',
    time: '14:32',
    amount: 39.48,
    fee: 0.52,
    id: '16d5a389-4829-44bf-852f-a9f3d39c55d1',
  },
  {
    date: '2025-04-12',
    time: '17:18',
    amount: 276.36,
    fee: 3.64,
    id: '11d84820-c22f-44d3-83c1-5ff17e2e0696',
  },
  {
    date: '2025-04-15',
    time: '11:21',
    amount: 61.19,
    fee: 0.81,
    id: '4cbc29c1-1506-4298-afbc-0ddcacc11bee',
  },
  {
    date: '2025-04-16',
    time: '10:19',
    amount: 29.61,
    fee: 0.39,
    id: '93fe6ad5-6ecd-40c7-bfa8-ef0f7fd8b026',
  },
  {
    date: '2025-04-16',
    time: '10:19',
    amount: 24.67,
    fee: 0.33,
    id: '70e0f64e-76ad-4dd1-8d94-be9591ee11f3',
  },
  {
    date: '2025-04-19',
    time: '16:08',
    amount: 111.53,
    fee: 1.47,
    id: 'de10455b-3afd-4215-904c-a083117d1310',
  },
  {
    date: '2025-04-26',
    time: '11:39',
    amount: 88.83,
    fee: 1.17,
    id: '157be383-d611-4319-9e00-78ad3f9c01f4',
  },
  {
    date: '2025-04-30',
    time: '11:44',
    amount: 155.95,
    fee: 2.05,
    id: 'bcc705e1-ae2d-40b1-96dc-718728e9ec68',
  },
  {
    date: '2025-04-30',
    time: '14:25',
    amount: 29.61,
    fee: 0.39,
    id: '6da1d4d5-709d-4780-a35c-45c926d8f0f6',
  },
  {
    date: '2025-04-30',
    time: '14:25',
    amount: 24.67,
    fee: 0.33,
    id: '2a810d1e-c4c3-4454-bfed-65d353d62545',
  },
]
...
const HAIR_SERVICES: ItemImport[] = [
  // Haarschnitte
  { name: 'Haarschnitt Damen', default_price: 85.0, type: 'service', is_favorite: true },
  { name: 'Haarschnitt Herren', default_price: 65.0, type: 'service', is_favorite: true },
  { name: 'Kinderhaarschnitt', default_price: 45.0, type: 'service' },
  { name: 'Pony schneiden', default_price: 25.0, type: 'service' },

  // Färbungen & Tönung
  { name: 'Komplettfärbung', default_price: 120.0, type: 'service', is_favorite: true },
  { name: 'Ansatzfärbung', default_price: 80.0, type: 'service', is_favorite: true },
  { name: 'Strähnen', default_price: 95.0, type: 'service' },
  { name: 'Balayage', default_price: 150.0, type: 'service' },
  { name: 'Tönung', default_price: 60.0, type: 'service' },

  // Styling & Pflege
  { name: 'Föhnen & Styling', default_price: 35.0, type: 'service' },
  { name: 'Hochsteckfrisur', default_price: 75.0, type: 'service' },
  { name: 'Haarkur-Behandlung', default_price: 45.0, type: 'service' },
  { name: 'Kopfhautmassage', default_price: 25.0, type: 'service' },

  // Spezialbehandlungen
  { name: 'Dauerwelle', default_price: 110.0, type: 'service' },
  { name: 'Glättung', default_price: 130.0, type: 'service' },
  { name: 'Haarverlängerung', default_price: 220.0, type: 'service' },

  // Produkte
  { name: 'Shampoo Professional', default_price: 28.0, type: 'product' },
  { name: 'Conditioner Professional', default_price: 32.0, type: 'product' },
  { name: 'Haaröl Treatment', default_price: 45.0, type: 'product' },
  { name: 'Styling Gel', default_price: 22.0, type: 'product' },
]
 ...
 */
function generateRealisticServiceCombination(
  targetAmount: number
): Array<{ item_name: string; price: number }> {
...
export function generateSettlementTestData(): {
  ...
  const cashSales = [
    { date: '2025-04-01', time: '09:30', amount: 85.0, service: 'Haarschnitt Damen' },
    { date: '2025-04-05', time: '14:15', amount: 65.0, service: 'Haarschnitt Herren' },
    { date: '2025-04-10', time: '11:45', amount: 120.0, service: 'Komplettfärbung' },
    { date: '2025-04-18', time: '16:20', amount: 45.0, service: 'Kinderhaarschnitt' },
    { date: '2025-04-25', time: '10:00', amount: 95.0, service: 'Strähnen' },
  ]
