      ...
      <CardContent>
        {loading ? (
          ...
          <>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-md p-3 flex items-start mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700">
                    Auth- und DB-Benutzer sind nicht synchronisiert. Dies verursacht
                    Berechtigungsprobleme bei Datenbankoperationen.
                  </p>
                </div>
              </div>
            )}
            ...
            {!isConfigOk && authUser && (
              <Button onClick={synchronizeUser} disabled={syncing} className="w-full">
                {syncing ? (
                  <>
